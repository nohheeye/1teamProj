...
<h2 class="font-face" align="center">공모전 일정 추가하기</h2><hr>
...
<div class="col-lg-7">
<form action="/contest/write" method="POST" class="form-horizontal font-face" style="padding-top:10%;" >
			  <div class="form-group">
			    <label class="col-sm-2 control-label">공모전 명</label> 
			    <div class="col-md-8">
			     	
			      <input type="text" class="form-control" placeholder="공모전 명을 입력하세요" name="contest_title" >
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-md-8">	
			      <input type="text" class="form-control" placeholder="공모전의 분야를 입력하세요" name="contest_field">
			    </div>
			  </div>
			  <div class="form-group">
			    <label class="col-sm-2 control-label">주최/주관</label> 
			    <div class="col-md-8">	
			      <input type="text" class="form-control" placeholder="주최/주관을 입력하세요"  name="contest_sponser">
			    </div>
			  </div>
			    <div class="form-group">
			   <label class="col-sm-2 control-label">출처</label> 
			    <div class="col-md-8">	
			      <input type="text" class="form-control" placeholder="출처를 입력하세요"  name="contest_content">
			    </div>
			  </div>

			  
			     
 <div class="form-inline font-face" style="padding-left:3%;">
<label class="control-label">접수기간</label> 
				<div class="form-group">
			    <div class="col-md-8" style="padding-left:15%;">	
			      <input type="date" class="form-control" name="contest_start">
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    <div class="col-md-8">
			      <input type="date" class="form-control" name="contest_end">
			    </div>
			  </div>
 ...
 <br><br> 
 <input type="submit" class="newmember_btn font-face" value="저장" data-toggle="modal" data-target="#myModal">
 <button type="button" class="newmember_btn font-face" id="newmember_btn" style="background-color:#d9d9d9" onclick="location='/contest/list'">취소</button>
</div>
         ...
         <div class="modal-dialog" style="width: 400px">
            ...
            <div class="modal-content" style="font-family: Nanum Square;">
               ...
               <div class="modal-body"
                  ...
                  <h4
                     style="text-align: center; font-family: Nanum Square; padding-top: 20px">저장이 완료되었습니다.</h4>
               ...
               <div class="modal-footer"
                  ...
                  <button type="button" class="button newmember_btn"
                     ...
                     onclick='location="/contest/list"'>확인</button>
