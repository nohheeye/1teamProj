	...
	<%!public String getDateName(int monthNumber) { // This method is used to quickly return the proper name of a month
		...
		return strReturn;
				   ...
				   <table class="font-face" width='350' celpadding='0' cellspacing='0'>
						  <tr>
						   <td width='70' align='center' valign='middle'><a href="writeView?month=<%=currMonth%>&year=<%=currYear%>&action=0"><font size="5" color="#3b5998"> < </font></a></td>
						   ...
						   <td width='70' align='center' valign='middle'><a href="writeView?month=<%=currMonth%>&year=<%=currYear%>&action=1"><font size="5" color="#3b5998"> > </font></a></td>
						  </tr>
					</table>
					...
					<table class="font-face" border="0" width="520" bordercolorlight="#C0C0C0" bordercolordark="#808080" style="border-collapse: collapse" bordercolor="#3b5998" cellpadding="0" cellspacing="0">
						...
						<div class="col-md-8 pull-right">
							<form action="/schedule/write" method="post" class="form-horizontal">
								<div class="form-group">
								<label class="col-sm-2 control-label">제목</label>
								<div class="col-md-9">
								<input type="text" class="form-control" name="sch_title" placeholder="일정제목을 입력하세요"> <br>
								</div>
								</div>
								...
								<div class="col-md-9">
								<input type="text" class="form-control" name="sch_place" placeholder="장소를 입력하세요"> <br>
								</div>
								</div>
								...
								<div class="col-md-9">
								<input type="date" class="form-control" name="sch_date"> <br>
								</div>
								</div>
								...
								<div class="col-md-9">
								<input type="time" class="form-control" name="sch_time"> <br>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" name="sch_content" placeholder="내용을 입력하세요" style="width: 100%;" rows=12 style="width: 100%;" id="bbsContent" maxlength="20480"></textarea> <br>
		<!-- 								<b class="pull-right" style="color:#ff6f69"><input type="checkbox" >일정메일보내기</b> -->
									</div>
								</div>

								
								<div class="plan_btn" style="padding-left:73%">
									<input type="submit" class="button" value="저장">
									<button type="button" class="button" style="background-color:#d9d9d9" onclick="location='/schedule/list'">취소</button>
								</div>
								</form>
							</div>
